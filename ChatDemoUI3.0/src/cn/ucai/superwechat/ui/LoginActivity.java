...
public class LoginActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        txtMtitle.setText(R.string.login);
    }
    ...
    @OnClick({R.id.img_back, R.id.btn_send, R.id.btn_Login_login, R.id.tv_login_problem, R.id.bt_inLogin_register})
