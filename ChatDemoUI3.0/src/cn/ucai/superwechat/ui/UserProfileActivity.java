...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    private void initView() {
        ...
        txtMtitle.setText(getString(R.string.title_user_profile));
    }
    ...
    @OnClick({R.id.img_back, R.id.iv_userinfo_avatar, R.id.layout_user_avatar, R.id.layout_userinfo_nick, R.id.layout_userinfo_name})
